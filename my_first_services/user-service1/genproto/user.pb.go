...
type GetUsersResponce struct {
	User1                []*User  `protobuf:"bytes,1,rep,name=user1,proto3" json:"user1"`
...
func (m *GetUsersResponce) Reset()         { *m = GetUsersResponce{} }
func (m *GetUsersResponce) String() string { return proto.CompactTextString(m) }
func (*GetUsersResponce) ProtoMessage()    {}
func (*GetUsersResponce) Descriptor() ([]byte, []int) {
	return fileDescriptor_116e343673f7ffaf, []int{1}
}
func (m *GetUsersResponce) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetUsersResponce) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetUsersResponce.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetUsersResponce) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetUsersResponce.Merge(m, src)
}
func (m *GetUsersResponce) XXX_Size() int {
	return m.Size()
}
func (m *GetUsersResponce) XXX_DiscardUnknown() {
	xxx_messageInfo_GetUsersResponce.DiscardUnknown(m)
}

var xxx_messageInfo_GetUsersResponce proto.InternalMessageInfo

func (m *GetUsersResponce) GetUser1() []*User {
	if m != nil {
		return m.User1
	}
	return nil
...
func (m *GetUsersResponce) GetCount() int64 {
	if m != nil {
		return m.Count
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*GetUsersResponce)(nil), "user.GetUsersResponce")
...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	,
}
...
type UserServiceClient interface {
	...
	GetUserList(ctx context.Context, in *GetUsersRequest, opts ...grpc.CallOption) (*GetUsersResponce, error)
}
...
func (c *userServiceClient) GetUserList(ctx context.Context, in *GetUsersRequest, opts ...grpc.CallOption) (*GetUsersResponce, error) {
...
type UserServiceServer interface {
	...
	GetUserList(context.Context, *GetUsersRequest) (*GetUsersResponce, error)
}
...
func (*UnimplementedUserServiceServer) GetUserList(ctx context.Context, req *GetUsersRequest) (*GetUsersResponce, error) {
...
func (m *GetUsersResponce) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetUsersResponce) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetUsersResponce) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.User1) > 0 {
		for iNdEx := len(m.User1) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.User1[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GetUsersResponce) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetUsersResponce) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetUsersResponce: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetUsersResponce: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field User1", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.User1 = append(m.User1, &User{})
			if err := m.User1[len(m.User1)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
